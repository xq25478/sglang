...
def _online_combine_kernel(
    ...
    # Degenerate rows (for example, all -inf logits) leave every candidate at
    # the sentinel. Emit a valid token rather than indexing the vocabulary with
    # 2147483647 in the following verify step.
